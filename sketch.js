...
for (var i = 0; i <playerArrows.length; i++){
  ...
  if(baseCollision.collided || archerCollusion.collided || computerCollision.collided){
...
function handleComputerArrowCollision() {
  ...
  for (var i = 0; i < computerArrows.length; i++){
    var baseCollision = Matter.SAT.collides(computerArrows[i].body, playerBase.body);
    var archerCollision = Matter.SAT.collides(computerArrows[i].body,playerArcher.body);
